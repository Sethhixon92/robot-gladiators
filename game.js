...
var enemyHealth = 50;
var enemyAttack = 12;
//Fight function (now the parameter for enemy's name)
var fight = function(enemyName) {
  while (playerHealth > 0 && enemyHealth > 0) {
  //Asks if the player would like to fight or run 
  var promptFight = window.prompt("Would you like to FIGHT or SKIP this battle? Enter 'FIGHT or 'SKIP' to choose.");
    ...
    if (enemyHealth <= 0) {
      ...
      //award the player money for winning
...
//after the loop ends, the player is either out of health or enemies to fight, so run endGame function
endGame();
};
